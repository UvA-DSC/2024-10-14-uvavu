...
address: "UvA, Roeterseiland Campus, Valckenierstraat 61, REC V 0.14"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
humandate: "Date: October 14 - 17, 2024"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "Time: 09.30 - 14.30"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
...
instructor: ["Justin Ho", "Joachim Goedhart", "Elisa Rodenburg", "Sophie Arnoult"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Eva Lekkerkerker", "Stephanie van de Sandt", "Noor Breuning", "Louis Nagtegaal", "Olaf Zwennes", "Meron Vermaas", "Martijn Wehrens"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes:  https://pad.carpentries.org/2024-10-14-uvavu # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
